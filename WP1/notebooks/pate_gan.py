...
# Necessary packages
#import tensorflow as tf ## edited
...
def pategan(x_train, parameters, n_synth):
  ...
  Args:
    ...
    - parameters: PATE-GAN parameters
      ...
      - lamda: noise size
    - n_synth: number of synthetic data instances to produce
  ...
  x_train_hat = sess.run([G_sample], feed_dict = {Z: sample_Z(n_synth, z_dim)})[0]
